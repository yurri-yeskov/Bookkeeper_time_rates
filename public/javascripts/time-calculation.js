        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            for (var i = 1; i < data.product_profile_nid.length; i++) {
              product_profile_nid_str =
                product_profile_nid_str + "," + data.product_profile_nid[i];
              var product_tr_id =
                "#" + data.product_profile_nid[i].substring(1);
              $("#product-content")
                .find(product_tr_id)
                .css("display", "contents");
            }
            ...
            $("#calculation-value").html(
              "" + data.calc_val + product_profile_nid_str
            );
          },
        });
      },
