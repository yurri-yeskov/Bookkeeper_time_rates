...
function headRows() {
  return [{ 
    ...
    reporter_name: {content: 'Reporter Name', styles: { valign: 'middle', halign: 'center', fontSize: 6 }}, 
...
function bodyRows(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    body.push({
      ...
      reporter_name: {content: data[i].reporter_name, styles: { valign: 'middle', halign: 'center', fontSize: 6 }}, 
