...
const query_str = "CREATE TABLE IF NOT EXISTS task_manager.time_elements (id SERIAL, element_id VARCHAR(4) NOT NULL, element_name VARCHAR(100) NOT NULL, element_value FLOAT(4), note TEXT, PRIMARY KEY (id)); " +
                    ...
                    "CREATE TABLE IF NOT EXISTS task_manager.time_entries (id SERIAL, customer_id INTEGER REFERENCES public.customers (id) NOT NULL, company_name VARCHAR(255), bookkeeper_name VARCHAR(255), email_address VARCHAR(255), task_type VARCHAR(255), period VARCHAR(20), " + 
                    ...
                    "CREATE TABLE IF NOT EXISTS task_manager.time_audit_log (id SERIAL, customer_id INTEGER REFERENCES public.customers (id) NOT NULL, company_name VARCHAR(255), bookkeeper_name VARCHAR(255), email_address VARCHAR(255), " +
